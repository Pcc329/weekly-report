...
| 項目 | 連結 |
|---|---|
| 📄 資料庫升級評估（主任報告） | https://pcc329.github.io/weekly-report/docs/db_upgrade_roadmap_20260730.html |
...
| 📝 結構化週報製作方法 | https://pcc329.github.io/weekly-report/docs/weekly_report_method_sharing_20260716.html |
...
> 分類原則：同一家 Claude 拆成兩筆——訂閱屬「開發費用」（建置期成本、會趨於平緩），API 用量屬「AI 推論／營運」（隨使用人數成長）。逐項明細與 18 個月費用預估詳見[資料庫升級評估報告](https://pcc329.github.io/weekly-report/docs/db_upgrade_roadmap_20260730.html)。
